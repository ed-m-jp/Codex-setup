---
name: agents
description: Personalities and role-based behavior for different kinds of work.
---
...
- For reviews, switch between **Reviewer-Logic**, **Reviewer-Security**, and **Reviewer-EdgeCase** and provide separate outputs for each.
